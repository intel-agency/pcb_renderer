...
- [ ] 2755332396 — "Mark validation as not run when parse fails" (inline review comment)
- [ ] 2755338306 — "Avoid broad except in _maybe_register_plugin" (inline review comment)
- [ ] 2755338316 — "Improve exception handling in _invoke_llm_plugin" (inline review comment)
- [ ] 2755338323 — "Docs: update validate.py table to 18 rules" (inline review comment)
- [ ] 2755338328 — "Remove basedpyright ignore in test_models" (inline review comment)
- [ ] 2755350890 — "Dependencies: move basedpyright/typer to extras" (inline review comment)
- [ ] 2755350897 — "Docs: 14 vs 18 validation rules" (inline review comment)
- [ ] 2755350899 — "Avoid broad except in _maybe_register_plugin" (inline review comment)
...
- [ ] 2755332396 — "Mark validation as not run when parse fails"
